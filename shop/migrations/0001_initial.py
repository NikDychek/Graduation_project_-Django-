    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='shop.itemtag', verbose_name='Категория')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='shop.TaggedItem', to='shop.ItemTag', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Товар',
